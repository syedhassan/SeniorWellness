...
public class NotificationNewFriendSignUp extends FragmentActivity{
	...
	public void onCreate(Bundle savedInstanceState){
		...
		setContentView(R.layout.notificationnewfriendsignup);
		...
		detailsButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				SharedPreferences settings =  NotificationNewFriendSignUp.this.getSharedPreferences(PREFS_NAME, 0);
				SharedPreferences.Editor editor = settings.edit();
				editor.putBoolean("newNotificationFriendSignUp", true);
				editor.putInt("newNotificationPosition", eventPosition);
				editor.commit();

				Intent mainIntent = new Intent(NotificationNewFriendSignUp.this, Main.class);
