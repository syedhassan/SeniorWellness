...
public class GetEventDataObject extends Thread implements Runnable {
	...
	public GetEventDataObject (CyclicBarrier barrier, Context context, String userId, Handler handler) {
		this.userId = userId;
	...
	@Override
	public void run() {
		Log.i(TAG, "Entering the thread GetEventDataObject");
