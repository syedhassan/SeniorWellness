...
public class ConfirmSignOutEvent extends Thread implements Runnable {
	...
	public ConfirmSignOutEvent (Context context, String userId, String eventId, String text, Handler handler) {
		this.userId = userId;
	...
	public void run() {
		...
		try {
			...
			if (result == 200 & responseString.contains("200-OK")) {
				...
				text.setText("Please try again to SignOut for your event");
				Toast toast = new Toast(context);
				toast.setGravity(Gravity.CENTER_VERTICAL, 0, 0);
				toast.setDuration(1000);
				toast.setView(layout);
				toast.show();
//				Toast.makeText(context, "Please try again to SignOut for your event", 1000).show();
