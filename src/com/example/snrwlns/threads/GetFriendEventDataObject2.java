...
public class GetFriendEventDataObject2 extends Thread implements Runnable {
	...
	protected String serverLink = "http://arcweb.arctry.com:8080/snrwlns_server/Main?getFriendEventDataForPhone2";
	protected static final String demoServerLink = "http://arcweb.arctry.com:8080/snrwlns_server1/Main?getFriendEventDataForPhone2";
	public static final String PREFS_NAME = "SNRWLNS";
	protected byte[] data;
	public GetFriendEventDataObject2 (Context context, String url, Handler handler) {
		this.url = url;
	...
	public void run() {
		...
		Log.i(TAG, "Entering the thread to send Get Friend's data item from server for url = "+url);
		...
		try {
			sleep(10);
			postMethod.setHeader("getFriendEventDataForPhone2", "getFriendEventDataForPhone2");
			postMethod.setHeader("url", url);
