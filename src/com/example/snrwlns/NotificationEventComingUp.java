...
public class NotificationEventComingUp extends Activity{
	...
	public void onCreate(Bundle savedInstanceState){
		...
		TextView signOutText = (TextView) findViewById(R.id.signOutText);
		signOutText.setText("Upcoming events");
		...
		detailsButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				SharedPreferences settings =  NotificationEventComingUp.this.getSharedPreferences(PREFS_NAME, 0);
				SharedPreferences.Editor editor = settings.edit();
				editor.putBoolean("newNotificationEvent", true);
				editor.putInt("newNotificationPosition", eventPosition);
				editor.commit();

				Intent mainIntent = new Intent(NotificationEventComingUp.this, Main.class);
				mainIntent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
    			startActivity(mainIntent);
    			NotificationEventComingUp.this.finish();
			}
		});
